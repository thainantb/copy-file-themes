                            ...
                            <div class="row justify-content-center g-3">
                                ...
                                foreach ($bloco['botoes'] as $item) {
                                    if (!empty($item['link']) && !empty($item['rotulo_botao'])) {
                                        $termoSCR = get_field('aplicar_termo_scr', $blocoContatopagina['formulario_dinamico']); ?>
                                        <div class="col-auto">
                                            <a href="<?php echo $comFormDinamico == true && $item['link']['url'] ==  $URLformDinamico ? '#formulario_dinamico_' . $blocoContatopagina['formulario_dinamico'] : $item['link']['url']; ?>" <?php echo $item['abrir_modal'] ? ' data-fancybox' : ''; ?> class="cp-botao" cor="destaque" <?php echo $termoSCR == true ? 'js-dispara-api' : ''; ?> estilo="com-icone" <?php echo $item['link']['target'] == '_blank' ? 'target="_blank"' : '' ?>>
                                                <span>
